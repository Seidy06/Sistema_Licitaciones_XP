...
public sealed class NivelAprobacionConfiguration : IEntityTypeConfiguration<NivelAprobacion>
{
    ...
    public void Configure(EntityTypeBuilder<NivelAprobacion> builder)
    {
        ...
        builder.HasData(
            new { Id = 1, Nombre = "Operativo", MontoMinimo = 0m, MontoMaximo = (decimal?)1_000_000m, CreatedAt = SeedDate, UpdatedAt = SeedDate },
            new { Id = 2, Nombre = "Gerencial", MontoMinimo = 1_000_000m, MontoMaximo = (decimal?)10_000_000m, CreatedAt = SeedDate, UpdatedAt = SeedDate },
            new { Id = 3, Nombre = "Directivo", MontoMinimo = 10_000_000m, MontoMaximo = (decimal?)null, CreatedAt = SeedDate, UpdatedAt = SeedDate });
    }
}
