...
Web aplica las migraciones de EF Core durante el arranque. La plantilla conserva las páginas base Home y Privacy; no existen interfaces funcionales para licitaciones, ofertas, niveles de aprobación ni tipos de cambio.
